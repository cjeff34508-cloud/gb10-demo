...
behavior, and what each one stresses on the GB10. Keyed by the exact dropdown
...
MODEL_INFO: dict[str, dict] = {
    ...
    "TinyLlama/TinyLlama-1.1B-Chat-v1.0": {
        ...
        "body": (
            ...
            "- **On GB10:** memory-trivial; useful for measuring the **framework / TTFT floor** "
    ...
    "unsloth/Llama-3.2-3B-Instruct": {
        ...
        "body": (
            ...
            "128 GB unified pool.\n"
            "- **On GB10:** the **base on-device narrator** (runs the talking-point generation at "
    ...
    "Qwen/Qwen2.5-7B-Instruct": {
        ...
        "body": (
            ...
            "- **On GB10:** comfortable single-user latency target; decode is memory-bandwidth bound, "
    ...
    "mistralai/Mistral-7B-v0.1": {
        ...
        "body": (
            ...
            "- **On GB10:** a clean 7B reference; pairs well with the 7B Qwen for cross-architecture "
    ...
    "microsoft/Phi-4": {
        ...
        "body": (
            ...
            "- **On GB10:** fits FP16 with ample headroom; good 'smart mid-size' demo where quality "
    ...
    "Qwen/Qwen2.5-14B-Instruct": {
        ...
        "body": (
            ...
            "- **On GB10:** fits FP16; a step up in quality from the 7B class at ~2× the memory and "
            "decode cost."
        ),
    },
    "mistralai/Mixtral-8x7B-Instruct-v0.1": {
        ...
        "body": (
            ...
            "- **On GB10:** FP16 is blocked by the memory guard (>100 GB usable); runs at **INT8 "
            "(~51 GB)** or **FP4 (~26 GB)** — a great 'only fits when quantized' talking point."
        ),
    },
    "Qwen/Qwen2.5-32B-Instruct": {
        "headline": "Qwen2.5 32B — largest dense model that fits GB10 at FP16",
        "body": (
            "- **Architecture:** dense decoder-only, grouped-query attention.\n"
            "- **Params:** 32.5B.\n"
            "- **Footprint:** ~64 GB FP16 / ~33 GB INT8 — fits the GB10's 128 GB unified pool at FP16.\n"
            "- **On GB10:** the upper bound for single-device FP16 inference here; decode is firmly "
    ...
    "nvidia/Qwen3-8B-NVFP4": {
        ...
        "body": (
            ...
            "- **Footprint:** ~5 GB.\n"
            "- **On GB10:** the **showcase for Blackwell hardware-accelerated FP4** — only valid at "
            "FP4/NVFP4 precision (loading it as FP16 produces garbage). Demonstrates the 4-bit "
            "memory + throughput win the GB10's tensor cores are built for."
        ),
    },
    ...
    "openai/clip-vit-base-patch32": {
        ...
        "body": (
            ...
            "- **Params:** ~151M.\n"
            "- **On GB10:** tiny; the benchmark drives the image tower with synthetic 224×224 batches "
    ...
    "openai/clip-vit-large-patch14": {
        ...
        "body": (
            ...
            "- **Params:** ~428M.\n"
            "- **On GB10:** ~3× the encoder compute of ViT-B/32; shows how finer patch size raises "
    ...
    "google/vit-base-patch16-224": {
        ...
        "body": (
            ...
            "- **Params:** ~86M.\n"
            "- **On GB10:** classic ViT throughput reference; 16px patches → 196 tokens/image, "
    ...
    "facebook/dino-vits16": {
        ...
        "body": (
            ...
            "- **Params:** ~21M.\n"
            "- **On GB10:** the lightest vision model here; useful as the speed/cost floor for the "
            "image pipeline."
        ),
    },
    "microsoft/resnet-50": {
        ...
        "body": (
            ...
            "- **Params:** ~25M.\n"
            "- **On GB10:** provides the **CNN-vs-Transformer** contrast — convolutions are compute- "
    ...
    "google/efficientnet-b4": {
        ...
        "body": (
            ...
            "- **Params:** ~19M.\n"
            "- **On GB10:** best accuracy-per-FLOP CNN in the set; pairs with ResNet-50 to show how "
    ...
    "MatMul Benchmark": {
        ...
        "body": (
            ...
            "- **On GB10:** the headline number for the chip's math throughput."
        ),
    },
    "Bandwidth Test": {
        ...
        "body": (
            ...
            "- **Reports:** effective GB/s against the GB10's ~273 GB/s LPDDR5X ceiling.\n"
            "- **On GB10:** directly measures the unified-memory bandwidth that gates LLM decode."
        ),
    },
    "LOB Bandwidth": {
        ...
        "body": (
            ...
            "- **On GB10:** models real exchange/HFT data movement, where access is irregular rather "
    ...
    "Reduction Ops": {
        ...
        "body": (
            ...
            "- **On GB10:** complements the Bandwidth Test with a reduction access pattern."
        ),
    },
    "Fill Memory (60%)": {
        ...
        "body": (
            ...
            "- **On GB10:** shows the chip holds bandwidth even when the 128 GB pool is heavily filled."
        ),
    },
    "Dual Model Serving": {
        ...
        "body": (
            ...
            "- **On GB10:** the multi-tenant / co-location story for the large unified memory."
        ),
    },
    "Black-Scholes Options": {
        ...
        "body": (
            ...
            "- **On GB10:** a real derivatives-pricing workload, not a synthetic stub."
        ),
    },
    "Monte Carlo VaR": {
        ...
        "body": (
            ...
            "- **On GB10:** a representative bank/treasury risk workload that leans on the large pool."
        ),
    },
}
...
DESIGNED_PRECISION: dict[str, tuple[str, str]] = {
    ...
    "mistralai/Mixtral-8x7B-Instruct-v0.1": ("BF16", "BF16-native MoE — on GB10 it only fits at INT8 or FP4"),
    "Qwen/Qwen2.5-32B-Instruct":          ("BF16", "BF16-native; fits FP16 within GB10's 128 GB pool"),
